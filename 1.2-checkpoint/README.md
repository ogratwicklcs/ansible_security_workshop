...
Test the access to the MGMT server by using RDP client to connect to the IP of your `windows` node in your inventory (which should be located at the bottom of the inventory file we opened in the last section).
